            ...
            <div class="min-w-full divide-y divide-bordercolor/20">
              ...
              >
                <div class="grid grid-cols-12 gap-4 px-6 py-4 items-center w-full">
                  <div
                    class="col-span-6 flex justify-start w-full items-end sm:col-span-6 lg:col-span-3 xl:col-span-3"
                  >
                  ...
                  <div
                    class="hidden md:block md:col-span-3 lg:col-span-2 xl:col-span-2"
                  >
                    <UPopover class="border border-bordercolor">
                      <UBadge
                        v-if="team.membership"
                        variant="soft"
                        size="md"
                      ...
                      <template #content>
                        <div class="size-48 rounded-2xl inline-flex border-[1px] bg-primary border-bordercolor">
                          <div
                            ref="popup"
